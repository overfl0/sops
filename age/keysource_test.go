...
func overwriteUserConfigDir(t *testing.T, path string) {
	...
	case "darwin", "ios": // This adds "/Library/Application Support" as a suffix to $HOME for the config dir
		t.Setenv("HOME", path)
	case "plan9": // This adds "/lib" as a suffix to $home for the config dir
		t.Setenv("home", path)
	default: // Unix
